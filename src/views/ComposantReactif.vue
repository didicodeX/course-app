      ...
      <div class="lesson">
        ...
        <div class="range">
          <div class="color-container">
            ...
            <div class="color" :style="{ backgroundColor: `rgb(${redRange},${greenRange},${blueRange})` }"></div>
          </div>
...
// *************** Watch *****************
// On peut avoir une callback function et une fonctionasynchrone dans notre watch    contrairement au computed
